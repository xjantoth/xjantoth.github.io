---
title: "Go http.Redirect(...) http.StatusTemporaryRedirect 307"
date: "2022-01-06T14:23:31+0100"
lastmod: "2022-01-06T14:23:31+0100"
draft: false
author: "Jan Toth"
image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=420&fit=crop"
description: "How to perform a 307 Temporary Redirect in Go using http.Redirect, which preserves the original HTTP method during redirection."

tags: ['go', 'http.statustemporaryredirect']
categories: ["Go"]
---

This example demonstrates a 307 (Temporary Redirect) in Go. Unlike a 303 redirect, a 307 redirect preserves the original HTTP method. If a POST request hits `/bar`, the redirect to `/` will also be a POST request. This is important when you need the redirected request to maintain the same method and body as the original.
