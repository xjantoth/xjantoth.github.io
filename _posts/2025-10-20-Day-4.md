...
draft: false
author: "Jan Toth"
description: "Advent of Code Day 4 solution in Go: parse and validate passport data with required fields and strict value rules."
...
This Go program solves Advent of Code Day 4. It parses passport data separated by blank lines, validates that all required fields are present (Part 1), and then applies strict value constraints such as year ranges, height units, hair color format, and passport ID format (Part 2).
